...
\end{semiverbatim}
      ...
      \end{itemize}
      \begin{block}{Resultado (20 threads)}
        \textbf{0,132 s $\rightarrow$ 17,5$\times$}
      \end{block}
    \column{0.48\textwidth}
...
\end{semiverbatim}
      ...
      \end{itemize}
      \begin{alertblock}{Resultado (20 threads)}
        \textbf{10,193 s $\rightarrow$ 0,23$\times$}
      \end{alertblock}
  \end{columns}
  \vfill
  \centering
  \footnotesize Baseline v0 (1 thread): 2,298 s --- com os mesmos 20 cores, a v3 ficou 4,4$\times$ mais lenta que o sequencial.
\end{frame}
